...
export const metadata: Metadata = {
  title: { absolute: "Monova Marketing" },
  description: "Crea, planifica y gestiona tu marketing con la plataforma de Monova."
};
  ...
  return (
    <main className="marketing-page">
      <nav className="marketing-nav">
        <Link href="/marketing" className="brand-lockup"><span className="brand-mark">M</span><span>MONOVA MARKETING</span></Link>
        <div className="nav-links">
          <Link href="/">Monova Agencia</Link>
      ...
      <footer><span>© 2026 Monova</span><div><Link href="/recursos">Recursos</Link><Link href="/contacto">Contacto</Link><Link href="/">Monova Agencia</Link></div></footer>
    </main>
  );
}
